...
--thêm nhân viên------
INSERT INTO Nhanvien(Ten, GioiTinh, SDT, NgaySinh, Diachi, Email, PhanQuyen)
...
CREATE TABLE [dbo].[Nhanvien] (
    [MaNV] AS ('NV' + RIGHT('00000' + CAST(AutoID AS VARCHAR), 5)) PERSISTED NOT NULL,
...
CREATE TABLE [dbo].[Phieu] (
    [MaPhieu] AS ('PM' + CAST(AutoID AS VARCHAR)) PERSISTED NOT NULL,
    [AutoID] INT IDENTITY(100000,1) NOT NULL,
    [MaDG] CHAR(10) NULL,
    [NgayMuon] DATE NULL,
    [NgayTra] DATE NULL,
...
CREATE TABLE [dbo].[Sach] (
    [MaSach] AS ('SG' + CAST(AutoID AS VARCHAR)) PERSISTED NOT NULL,
    [AutoID] INT IDENTITY(100000,1) NOT NULL,
...
CREATE TABLE [dbo].[TacGia] (
    [MaTG] AS ('TG' + CAST(AutoID AS VARCHAR)) PERSISTED NOT NULL,
    [AutoID] INT IDENTITY(100000,1) NOT NULL,
    [Ten] NVARCHAR(50) NULL,
    [NgaySinh] DATE NULL,
...
CREATE TABLE [dbo].[TheLoai] (
    [MaTL] AS ('TL' + CAST(AutoID AS VARCHAR)) PERSISTED NOT NULL,
    [AutoID] INT IDENTITY(100000,1) NOT NULL,
    [Ten] NVARCHAR(50) NULL,
...
INSERT [dbo].[Nhanvien] ([Ten], [GioiTinh], [SDT], [NgaySinh], [Diachi], [Email], [PhanQuyen]) VALUES (N'Trường', N'Nam', N'0353573467', CAST(N'2020-07-10' AS Date), N'Quận 9', N'truong@gmail.com', N'Nhân Viên')
INSERT [dbo].[Nhanvien] ([Ten], [GioiTinh], [SDT], [NgaySinh], [Diachi], [Email], [PhanQuyen]) VALUES (N'Tuấn', N'Nam', N'0369696896', CAST(N'2000-07-14' AS Date), N'Quận 9', N'Tuanml@gmail.com', N'Nhân Viên')
INSERT [dbo].[Nhanvien] ([Ten], [GioiTinh], [SDT], [NgaySinh], [Diachi], [Email], [PhanQuyen]) VALUES (N'Vũ', N'Nam', N'0369696896', CAST(N'2000-03-14' AS Date), N'Quận 9', N'Vuml@gmail.com', N'Nhân Viên')
INSERT [dbo].[Nhanvien] ([Ten], [GioiTinh], [SDT], [NgaySinh], [Diachi], [Email], [PhanQuyen]) VALUES (N'Nguyễn Hoàng Vương', N'Nam', N'0365868584', CAST(N'2000-04-12' AS Date), N'Quận 9', N'Vuongmk@gmail.com', N'Quản Lý')
GO

INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071111', CAST(N'2020-07-07' AS Date), CAST(N'2020-07-21' AS Date), N'Phieu Tra', 1)
INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071119', CAST(N'2020-07-08' AS Date), CAST(N'2020-07-22' AS Date), N'Phieu Tra', 5)
INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071117', CAST(N'2020-07-08' AS Date), CAST(N'2020-07-22' AS Date), N'Phieu Tra', 6)
INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071120', CAST(N'2020-07-08' AS Date), CAST(N'2020-07-22' AS Date), N'Phieu Muon', 4)
INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071114', CAST(N'2020-07-08' AS Date), CAST(N'2020-07-22' AS Date), N'Phieu Muon', 1)
INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071112', CAST(N'2020-07-08' AS Date), CAST(N'2020-07-22' AS Date), N'Phieu Muon', 1)
INSERT [dbo].[Phieu] ([MaDG], [NgayMuon], [NgayTra], [LoaiPhieu], [Tong]) VALUES (N'5951071118', CAST(N'2020-07-08' AS Date), CAST(N'2020-07-22' AS Date), N'Phieu Muon', 1)
GO
...
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Lập trình và cuộc sống ', N'TL100004  ', 29, N'NXB Thanh Niên', CAST(N'2020-07-07' AS Date), N'Anh cần một cách để theo dõi sự phát triển của phần mềm theo thời gian-bất cứ điều gì anh ta nghĩ đến hoặc làm việc trên nó. Jeff đã nghiên cứu các chủ đề mà anh cảm thấy thú vị, sau đó ghi lại nghiên cứu của mình bằng một bài đăng trên blog mà anh có thể dễ dàng tìm lại và tham khải sau này.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Giáo Trình C++ & Lập Trình Hướng Đối Tượng', N'TL100004  ', 18, N'NXB Hồng Đức', CAST(N'2020-07-07' AS Date), N'Giáo trình C++ & lập trình hướng đối tượng” trình bày một cách hệ thống các khái niệm của lập trình hướng đối tượng được cài đặt trong C++ như lớp, đối tượng, sự thừa kế, tính tương ứng bội và các khả năng mới trong xây dựng, sử dụng hàm như đối tham chiếu, đối mặc định, hàm trùng tên, hàm toán tử.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Lập Trình Với C# ', N'TL100004  ', 20, N'NXB Thanh Niên', CAST(N'2020-07-07' AS Date), N'Trình bày các khai niên và xây dựng ứng dụng bằng ngôn ngữ c#')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Những Câu Hỏi Lớn', N'TL100006  ', 12, N'NXB Dân Trí', CAST(N'2020-07-07' AS Date), N'NHỮNG CÂU HỎI LỚN đề cập đến những vấn đề cơ bản trong khoa học tự nhiên và xã hội, nhưng vẫn khiến những bộ óc vĩ đại trong lịch sử đau đầu.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Một Thiên Tiểu Thuyết', N'TL100006  ', 17, N'Nxb Thế giới', CAST(N'2020-07-07' AS Date), N'Hầu hết mọi người đều thích toán, tiếc là họ không biết điều này!
...
')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'A Mind For Numbers - Cách Chinh Phục Toán Và Khoa Học', N'TL100006  ', 25, N'Nxb Thế giới', CAST(N'2020-07-07' AS Date), N'A Mind for Numbers- Cách chinh phục Toán và Khoa học, đưa ra các cách thức giúp học sinh – sinh viên đang gặp rắc rối với môn toán và khoa học biết cách khai mở và sử dụng nguồn tài nguyên vô tận trong chính bộ não của mình, qua đó không chỉ chinh phục thành công bộ môn này mà đồng trời trở nên xuất sắc hơn bao giờ hết. Cuốn sách cũng giúp ích cho những người đã đi làm biết cách sáng tạo và sắp xếp công việc của mình, đồng thời phát triển nó lên một tầm cao mới, thông qua các kỹ thuật tư duy hoàn hảo.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Những Điều Tưởng Chừng Bất Khả', N'TL100007  ', 27, N'Nxb Thế giới', CAST(N'2020-07-07' AS Date), N'trong Vật lý của những điều tưởng chừng bất khả, nhà vật lý Michio Kaku khám phá khả năng đưa những công nghệ và thiết bị từ lãnh địa của khoa học viễn tưởng vào cuộc sống thường nhật trong tương lai.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Vật Lý Của Những Điều Tưởng Chừng Bất Khả', N'TL100007  ', 13, N'Nxb Thế giới', CAST(N'2020-07-07' AS Date), N'Trong Vật lý của những điều tưởng chừng bất khả, nhà vật lý Michio Kaku khám phá khả năng đưa những công nghệ và thiết bị từ lãnh địa của khoa học viễn tưởng vào cuộc sống thường nhật trong tương lai.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Bài Học Hay Nhất Về Vật Lý ', N'TL100007  ', 33, N'Nxb Thế giới', CAST(N'2020-07-07' AS Date), N'Cuốn sách 7 bài học hay nhất về Vật lý là một bản tổng kết nhanh những tri thức quan trọng đã tạo nên cuộc cách mạng vĩ đại trong nền vật lý thế kỷ XX như thuyết tương đối rộng, cơ học lượng tử, vũ trụ học, hạt cơ bản, lý thuyết hấp dẫn lượng tử, hố đen. Cuốn sách cũng đề cập đến ý nghĩa của tất cả những tri thức ấy với nhận thức của con người ngày nay.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Ngôi Nhà Việt', N'TL100008  ', 34, N'Nxb Tổng hợp TP.HCM', CAST(N'2020-07-07' AS Date), N'Tuy đã giảng dạy lâu năm về kiến trúc, nhưng khi được yêu cầu trình bày về ngôi nhà của thường dân người Việt, kiến trúc sư Thái thú nhận bản thân mình cũng lúng túng do chưa am hiểu thấu đáo về sự xuất hiện, tồn tại và biến chuyển của ngôi nhà. Chỉ gần đây, do yêu cầu viết một biên khảo về nếp ở của người Việt, anh mới tập trung nghiên cứu lại vấn đề một cách căn cơ hơn.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Những Ngôi Nhà Kết Hợp Công Việc', N'TL100008  ', 39, N'Nxb Trẻ', CAST(N'2020-07-07' AS Date), N'Bộ sách dành cho bạn trẻ luôn mong muốn sau này chính tay mình dựng lên những tòa nhà trong mơ dành cho mình và người thân, bạn bè.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Khám Phá Thiết Kế Đô Thị Hàn Quốc', N'TL100008  ', 26, N'NXB Văn hóa - Văn nghệ', CAST(N'2020-07-07' AS Date), N'Có thể nói rằng vấn đề của bản sắc đô thị Hàn Quốc nảy sinh từ chính sự thiếu nhận thức về bản thân chứ không phải từ điều gì khác. Điều này một phần cũng do những sai lầm lịch sử lâu dài bắt đầu từ thời Nhật đô hộ khi người Hàn Quốc dần quen nhìn nhận cuộc sống và không gian sống của bản thân bằng cái nhìn của người khác….')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Cuộc Sống Diệu Kỳ Của Các Nguyên Tố', N'TL100009  ', 37, N'Nxb Thế giới', CAST(N'2020-07-07' AS Date), N'Cuốn sách Cuộc Sống Diệu Kỳ Của Các Nguyên Tố thực sự là một sự kết hợp hoàn hảo giữa kiến thức khoa học kỳ thú và nghệ thuật vẽ truyện tranh đầy màu sắc. Dưới bàn tay khéo léo của họa sĩ Bunpei Yorifuji, thế giới siêu nhỏ của những hạt cơ bản trở nên sống động và gần gũi hơn bao giờ hết')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Nguyên Tố - Khám Phá Các Nguyên Tử Trong Vũ Trụ Qua Hình Ảnh', N'TL100009  ', 25, N'Nxb Trẻ', CAST(N'2020-07-07' AS Date), N'Theodore Gray say mê bảng tuần hoàn. Và bộ sưu tập các nguyên tố của ông sáng ngang với bất kỳ viện bảo tàng nào. Với sự hóm hĩnh đặc trưng và kiến thức uyên bác. Và trên hết là những bức ảnh lộng lẫy, ông đã cho thấy những ví dụ hấp dẫn - trải dài từ những điều tầm thường đến những ngã rẽ quanh co - về các tính chất và ứng dụng của mỗi nguyên tố')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Giáo Trình Hoá Học Đại Cương', N'TL100009  ', 22, N'Khoa học và kỹ thuật', CAST(N'2020-07-07' AS Date), N'Hoá học là một trong những lĩnh vực của khoa học tự nhiên nghiên cứu về thế giới vật chất và sự vận động của nó, nhằm tìm ra các quy luật vận động để vận dụng vào cuộc sống.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Quản Lý Dự Án Xây Dựng - Cẩm Nang Hướng Dẫn Thực Hành Quản Lý Thi Công Tại Công Trường', N'TL100010  ', 37, N'Khoa học và kỹ thuậtNxb Tổng hợp TP.HCM', CAST(N'2020-07-07' AS Date), N'Cầu đường bộ với một bản dự toán chi phí hoàn chỉnh, bao gồm các đơn vị đo lường quốc tế SI, sẽ minh họa cụ thể từng nguyên tắc quản lý dự án. Bằng cách sử dụng thông tin cơ bản này và các tình huống nghiên cứu trong phần phụ lục, độc giả sẽ có cơ hội nhận diện các vấn đề trong quản lý dự án và trải nghiệm cách thức xử lý thực tiễn.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Điều Khiển Xa Với ARDUINO & ESP32', N'TL100000  ', 34, N'Thanh Niên', CAST(N'2020-07-07' AS Date), N'Sách "Điều Khiển Xa Với ARDUINO & ESP32" giúp bạn bắt đầu làm việc với công nghệ phổ biến nhất trong thời điểm hiện tại (truyền thông không dây) để kết nối các thiết bị và hệ thống với Internet bằng cảm biến. ')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Sổ Tay Kỹ Thuật Thi Công Nhà Ở Gia Đình', N'TL100010  ', 30, N'NXB Khoa học và kỹ thuật', CAST(N'2020-07-07' AS Date), N'Cuốn sổ tay này chủ yếu đề cập đến các yêu cầu và kỹ thuật thi công các bộ phận của nhà, đặc biệt là một số kinh nghiệm từ thực thể thi công chống thấm cho mái bằng, cho tường ngoài, cho tường khu phụ, cho bể nước,... chống nóng cho mái bằng và nhất là kỹ thuật thi công móng của các loại đất nền, móng khi xây chen, móng cọc tre, khắc phục hiện tượng cát chảy; làm bếp cải tiến xây bể tự hoại,..')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Công Suất - Bộ Biến Đổi Cộng Hưởng Và Ballast Điện Tử', N'TL100000  ', 35, N'Thanh Niên', CAST(N'2020-07-07' AS Date), N': Điện tử công suất là môn học đã và đang được đưa vào giảng dạy tại các trường Cao đẳng, Đại học chuyên ngành điện. Môn học Điện tử công suất ngoài việc nghiên cứu bản chất vật lý, các quá trình diễn ra trong các linh kiện điện tử công suất như Diode, Thyristor, GTO, Triac, Mosfet công suất, IGBT, SID, MCT... làm việc ở chế độ chuyển mạch trong quá trình biến đổi điện năng. Khảo sát các tính năng kỹ thuật và những ứng dụng của các linh kiện này.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'. Cơ Sở Thiết Kế Và Gia Công Cơ Khí', N'TL100000  ', 38, N'Bách khoa Hà Nội', CAST(N'2020-07-07' AS Date), N'Cuốn sách này được biên soạn theo yêu cầu dạy học chuyên ngành lắp đặt và bảo trì sửa chữa thiết bị cơ điện cùng các chuyên ngành liên quan trong các trường trung cấp nghề hiện nay của Trung Quốc, có tham khảo các quy phạm thẩm định kỹ năng nghề của các ngành nghề liên quan và tiêu chuẩn cấp bậc công nhân kỹ thuật. ')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Ngôi Nhà Hạnh Phúc', N'TL100008  ', 39, N'Nxb Tổng hợp TP.HCM', CAST(N'2020-07-07' AS Date), N'Tuy đã giảng dạy lâu năm về kiến trúc, nhưng khi được yêu cầu trình bày về ngôi nhà của thường dân người Việt, kiến trúc sư Thái thú nhận bản thân mình cũng lúng túng do chưa am hiểu thấu đáo về sự xuất hiện, tồn tại và biến chuyển của ngôi nhà. Chỉ gần đây, do yêu cầu viết một biên khảo về nếp ở của người Việt, anh mới tập trung nghiên cứu lại vấn đề một cách căn cơ hơn.')
INSERT [dbo].[Sach] ([TenSach], [MaTL], [SL], [NXB], [NgayNhap], [NoiDung]) VALUES (N'Giai Tích', N'TL100006  ', 19, N'NXB Dân Trí', CAST(N'2020-07-07' AS Date), N'Toán học đại học .')
GO
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Jeff Atwood', CAST(N'2020-09-07' AS Date), N'aaa')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Tony Crilly', CAST(N'2020-10-07' AS Date), N'bb')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Michio Kaku', CAST(N'2000-02-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'S. Keoki Sears Glenn', CAST(N'2000-10-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Nguyễn Bá Đô', CAST(N'1991-02-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Bunpei Yorifuji', CAST(N'2000-07-06' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Nguyễn Hữu Thái', CAST(N'2000-08-07' AS Date), N'Tuy đã giảng dạy lâu năm về kiến trúc, nhưng khi được yêu cầu trình bày về ngôi nhà của thường dân người Việt, kiến trúc sư Thái thú nhận bản thân mình cũng lúng túng do chưa am hiểu thấu đáo về sự xuất hiện, tồn tại và biến chuyển của ngôi nhà. Chỉ gần đây, do yêu cầu viết một biên khảo về nếp ở của người Việt, anh mới tập trung nghiên cứu lại vấn đề một cách căn cơ hơn.')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Carlo Rovelli', CAST(N'2020-07-02' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Nguyễn thị Mi Sa', CAST(N'1999-07-22' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Phạm Quang Huy', CAST(N'1990-07-15' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Đàm Ngạn Phú', CAST(N'1888-07-22' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Lê Trường Thông', CAST(N'1990-07-19' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'NXB Thanh Niên', CAST(N'1898-01-13' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Nhã Phong', CAST(N'1896-01-19' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Trần Thị Minh Hiếu', CAST(N'1768-01-06' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Thới Ngọc Tuấn Quốc', CAST(N'1990-05-21' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Theodore Gray', CAST(N'1898-07-13' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'A. Sears Richard H.Clough', CAST(N'1889-09-14' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Lê Nguyễn Hồng Phong', CAST(N'1569-02-14' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Phạm Quang Huy', CAST(N'1888-08-14' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'GS Phạm Văn Ất', CAST(N'2000-07-22' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Mickaël Launay', CAST(N'2000-01-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Gerry Bailey', CAST(N'1999-02-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Kim Min-Soo', CAST(N'1888-07-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Nguyễn Minh Tuyền', CAST(N'1887-10-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Lê Sỹ Phong', CAST(N'1888-09-07' AS Date), N'Không có thông tin')
INSERT [dbo].[TacGia] ([Ten], [NgaySinh], [GioiThieu]) VALUES (N'Nguyễn Bá Đô', CAST(N'1888-02-07' AS Date), N'Không có thông tin')
GO
...
GO
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Điện , Điện Tử , Tự Động Hóa', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Khoa Học', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Tham Khảo', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'CNTT', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Toán', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Vật Lý', N'1111111111111')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Kiến Trúc', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Hóa Học', N'Không có thông tin')
INSERT [dbo].[TheLoai] ([Ten], [ThongTin]) VALUES (N'Xây Dựng', N'Không có thông tin')
GO
